...
if (isset($_POST['submit'])) {
    ...
    if (empty($loi)) {
        ...
        $sql = "INSERT INTO ctv(user_name, password, name, phone, email, profile, bill, status, code,rule,id_agency) VALUES('$user_name','$password','$hoten','$sdt','$email','$profile','$bill','$status','$code','freelancer',$idctv)";
        if (mysqli_query($conn, $sql)) {
            $minus = "UPDATE member SET bill = bill - $bill WHERE id_ctv=$idctv";
            if (mysqli_query($conn, $minus)) {
                echo "<script>alert('Đăng kí thành công, tài khoản này chưa đươc kích hoạt, quản lí lại mục Quản lí CTV!');window.location='index.php?DS=List_CTV';</script>";
            }
        }
    }
}
            ...
            <form class="form-horizontal" action="#" method="post">
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="money" value="<?php echo isset($_POST['money']) ? $_POST['money'] : ''; ?>" name="money" placeholder="Nhập số dư của tài khoản sau khi tạo thành công" required>
                        </div>
                    </div>
                ...
                <div class="box-footer">
                    <font color="red">Chú ý Link đăng nhập cho cộng tác viên là <b>http://VIP.BestAuto.Pro/index.php?DS=Login_CTV</b> nhé</font>
