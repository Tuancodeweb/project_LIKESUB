        ...
        if (mysqli_query($conn, $sql)) {
            ...
            if (mysqli_query($conn, $minus)) {
                ...
                if (mysqli_query($conn, $his)) {
                    echo '<script>alert("Gia hạn thành công"); window.location="index.php?DS=Manager_VIP_Reaction";</script>';
                }
            }
        }
    } else {
        echo '<script>alert("Số dư tài khoản của bạn không đủ !!! Vui lòng nạp thêm tiền đi nha!1"); window.location="index.php?DS=Manager_VIP_Reaction";</script>';
    }
}
?>
<div class="row">
